...
const KEY_DESCRIPTIONS: Record<string, string> = {
  ...
  footer_address: "사업장 주소 (PG 심사: 사업자등록증과 일치)",
  business_owner: "대표자명 (PG 심사: 사업자등록증과 일치)",
  business_reg_no: "사업자등록번호 (PG 심사: 사업자등록증과 일치)",
  business_phone: "사업장 전화번호 (푸터 표시)",
  ...
  return (
    <>
      <PageHeader
        ...
        desc={
          <>
            서비스명·연락처·hero 문구·약관·방침 등은 편집 시 사용자 페이지에 즉시 반영됩니다.
            약관·방침(HTML)은 저장 전 미리보기로 확인해주세요. 랜딩
            메뉴/stats/CTA(JSON)는 실수로 페이지가 깨질 수 있어 🔒
            읽기전용입니다(코드/배포로만 변경).
          </>
        }
      />
