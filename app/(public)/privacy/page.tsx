  ...
  return (
    <div className="flex-1 bg-gs-bg px-4 py-12">
      <article className="max-w-[820px] mx-auto bg-white rounded-[18px] shadow-gs-card p-8 md:p-12 prose prose-sm md:prose-base max-w-none">
        ...
        <h2 className="text-lg font-black mt-8 mb-2">1. 수집하는 개인정보 항목</h2>
        ...
        <h2 className="text-lg font-black mt-8 mb-2">2. 개인정보의 수집·이용 목적</h2>
        <ul className="list-disc pl-6">
        ...
        <h2 className="text-lg font-black mt-8 mb-2">3. 보유 및 이용기간</h2>
        <ul className="list-disc pl-6">
        ...
        <h2 className="text-lg font-black mt-8 mb-2">4. 제3자 제공</h2>
        <p>
        ...
        <h2 className="text-lg font-black mt-8 mb-2">5. 처리위탁</h2>
        <p>서비스 제공을 위해 다음 업체에 일부 처리를 위탁합니다.</p>
        <table className="w-full border-collapse my-2 text-sm">
          <thead>
            <tr className="bg-gs-surface-muted">
              <th className="border border-gs-line-soft p-2 text-left">수탁자</th>
              <th className="border border-gs-line-soft p-2 text-left">위탁 업무</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="border border-gs-line-soft p-2">Supabase Inc.</td>
              <td className="border border-gs-line-soft p-2">데이터베이스, 인증, 파일 저장</td>
            </tr>
            <tr>
              <td className="border border-gs-line-soft p-2">Vercel Inc.</td>
              <td className="border border-gs-line-soft p-2">웹 서비스 호스팅</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="border border-gs-line-soft p-2">결제 처리</td>
            </tr>
          </tbody>
        </table>

        <h2 className="text-lg font-black mt-8 mb-2">6. 이용자의 권리</h2>
        <p>이용자는 언제든지 개인정보 열람·수정·삭제·처리정지를 요청할 수 있으며, 회원 탈퇴를 통해 즉시 파기 요청이 가능합니다.</p>

        <h2 className="text-lg font-black mt-8 mb-2">7. 개인정보 보호책임자</h2>
        <p>
          개인정보 처리에 관한 문의·민원은 아래 연락처로 부탁드립니다.
        </p>
        <ul className="list-disc pl-6">
          <li>책임자: 개인정보보호 담당자</li>
          <li>이메일: <a href={`mailto:${CONTACT_EMAIL}`} className="text-gs-blue-hover underline">{CONTACT_EMAIL}</a></li>
        </ul>

        <h2 className="text-lg font-black mt-8 mb-2">8. 개정</h2>
