  ...
  return (
    <div className="flex-1 bg-gs-bg px-4 py-12">
      <article className="max-w-[820px] mx-auto bg-white rounded-[18px] shadow-[0_18px_40px_rgba(15,23,42,0.06)] p-8 md:p-12 prose prose-sm md:prose-base max-w-none">
        <h1 className="text-[24px] md:text-[28px] font-black mb-2">이용약관</h1>
        <p className="text-[#6b7280] text-sm">시행일: {EFFECTIVE_DATE}</p>

        <h2 className="text-[18px] font-black mt-8 mb-2">제1조 (목적)</h2>
        <p>
        ...
        <h2 className="text-[18px] font-black mt-8 mb-2">제2조 (정의)</h2>
        ...
        <h2 className="text-[18px] font-black mt-8 mb-2">제5조 (서비스의 제공 및 변경)</h2>
        <ul className="list-disc pl-6">
        ...
        <h2 className="text-[18px] font-black mt-8 mb-2">제6조 (의료적 책임의 한계)</h2>
        <p>
          본 서비스는 의료행위가 아니며, 정신건강의학과 진단·치료를 대체하지 않습니다. 심각한 우울·불안·자살 충동이 있다면
          전문의의 진료 또는 정신건강복지센터(1577-0199), 자살예방상담전화(1393)에 문의하시기 바랍니다.
        </p>

        <h2 className="text-[18px] font-black mt-8 mb-2">제7조 (유료서비스 및 환불)</h2>
        <ul className="list-disc pl-6">
        ...
        <h2 className="text-[18px] font-black mt-8 mb-2">제8조 (회원의 의무)</h2>
        <ul className="list-disc pl-6">
        ...
        <h2 className="text-[18px] font-black mt-8 mb-2">제9조 (계약 해지·이용 제한)</h2>
        <p>
          회원은 언제든지 마이페이지 또는 고객센터를 통해 회원 탈퇴할 수 있습니다.
          회사는 회원이 본 약관을 위반한 경우 사전 통지 후 이용을 제한하거나 계약을 해지할 수 있습니다.
        </p>

        <h2 className="text-[18px] font-black mt-8 mb-2">제10조 (책임의 한계)</h2>
        <ul className="list-disc pl-6">
        ...
        <h2 className="text-[18px] font-black mt-8 mb-2">제11조 (분쟁 해결)</h2>
        <p>
          서비스 이용으로 발생한 분쟁은 회사와 회원 간 협의를 통해 해결하되, 협의가 어려울 경우 서울중앙지방법원을 관할 법원으로 합니다.
        </p>

        <h2 className="text-[18px] font-black mt-8 mb-2">문의</h2>
        <p>
          이메일: <a href={`mailto:${CONTACT_EMAIL}`} className="text-[#1d4ed8] underline">{CONTACT_EMAIL}</a>
        </p>
      </article>
    </div>
  );
